...
require_once "classes/Lançamentos.php";
require_once "classes/Contas.php";
$lancamentos = new Lançamentos();
$listalancamento = $lancamentos->listartodos();
...
if (isset($_GET["excluir"])){
    $lancamentos->excluir($_POST["excluir"]);
}
$contas = new Contas();
...
<div class="navstyle">
    ...
    <ul class="nav ">
        ...
        <li class="nav-item">
            <a class=" nav-link linkativo " href="lancamentos.php">Lançamentos <i class="fa fa-line-chart" aria-hidden="true"></i></a>
        </li>
...
<div class="grid5">
        ...
        <div class="grid-item bla">
            <div class="subtitulo">
                <h3 class="bla"> Lançar Movimentação <i class="fa fa-tasks" aria-hidden="true"></i></i></h3>
            </div>
            <div class="bagulho">
                <form action="lancamentos.php" method="post">
                    <div class="form-group">
                        <div class="form-group">
                            ...
                            <select id="conta" name="conta" required class="form-control">
                                <option value="">Selecione uma opção</option>
                                <?php foreach ($listacontas as $contas) { ?>
                                    <option value="<?php echo $contas->NOME; ?>"> <?php echo $contas->NOME; ?> </option>
                                <?php } ?>
                            </select>
                        </div>
    ...
    <div class="grid-item bla">
        <table class="table table-dark">
            ...
            <tbody>
            <?php if ($listalancamento) :
                foreach ($listalancamento as $lancamentos) : ?>
                    <tr>
                        <td><?php echo $lancamentos->CONTAS; ?></td>
                        <td><?php echo $lancamentos->VALOR; ?></td>
                        <td>
